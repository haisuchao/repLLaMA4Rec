...
Ví dụ — eval only từ checkpoint đã lưu:
  python run_recbole.py eval saved/SASRec-May-12-2026_09-28-11.pth
...
def main():
    ...
    if len(sys.argv) < 3:
        ...
        print("  python run_recbole.py eval saved/SASRec-May-12-2026_09-28-11.pth")
        sys.exit(1)
