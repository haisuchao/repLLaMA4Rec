...
class ModelArguments:
    ...
    untie_encoder: bool = field(
        default=False,
        metadata={"help": "use two separate LoRA adapters for query/passage encoding instead of "
                           "one shared adapter, while still sharing a single frozen backbone "
                           "(memory-cheap untied bi-encoder). Requires --lora."}
    )
